...
function displayResults(schedule) {
  ...
  schedule.forEach(function(scheduleData) {
    ...
    var tr = $("<tr>").append(
        $("<td>").text(scheduleData.Time),
      $("<td>").text(scheduleData.Class),
      $("<td>").text(scheduleData.Teacher),
      console.log(scheduleData)
      // $("<td>").text("Present: " +  ) //+ <input type='checkbox'></input>
      // how do you input a checkbox here, and then make it unable to click when you client present
      ...
      //   }
      // }
      // $("<td>").text(scheduleData.weight),
      // $("<td>").text(scheduleData.whatIWouldReallyCallIt)
    );
